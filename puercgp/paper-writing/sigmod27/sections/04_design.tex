...
\input{figures/04_design/state_lifecycle}
...
\input{algorithms/shared_expand}
...
\input{algorithms/coalesced_gather}
...
\input{figures/04_design/planner}
...
\input{algorithms/online_planner}
...
\input{figures/04_design/selector_space}
